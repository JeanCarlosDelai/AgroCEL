  ...
  return (
    <div className="flex items-center justify-center">
      <button
        ...
        className="flex w-full rounded-md p-2 hover:bg-red-200  text-red-600 "
      >
        <svg
        ...
        >
          <div className="relative p-4 w-full max-w-md max-h-full">
            <div className="relative p-4 text-center bg-gray-700 rounded-lg shadow  sm:p-5">
              ...
              <svg
                className="text-red-500  w-11 h-11 mb-3.5 mx-auto"
                aria-hidden="true"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="mb-4 text-gray-300">
                Tem certeza que deseja excluir essa propriedade?
              </p>
              <div className="flex justify-center items-center space-x-4">
                <button
                  ...
                  data-modal-toggle="deleteModal"
                  type="button"
                  className="py-2 px-3 text-sm font-medium text-gray-700 bg-green-300 rounded-lg border border-green-200 hover:bg-green-400 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600"
                >
                  Não, cancelar
                </button>
                <button
                  ...
                  type="submit"
                  className="py-2 px-3 text-sm font-medium text-center text-white bg-red-500 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900"
                >
                  Sim, continuar
                </button>
              </div>
